...
_STATIC_SYSTEM_PROMPT = (
    ...
    "  **Phase 2b — openings** (à venir) : tool dédié pour ajouter "
    "  fenêtres/portes sur les murs validés. Pour l'instant, si "
    "  l'utilisateur demande explicitement les openings dans la même "
    "  itération, tu peux utiliser "
    "  `dwg_import_walls_and_openings_typed_many` mais signale "
    "  qu'il est moins propre (mélange murs + openings, plus difficile "
    "  à debug).\n"
