...
_STATIC_SYSTEM_PROMPT = (
    ...
    "  **Phase 2 (création BIM) — enchaîne 2a puis 2b dans le même tour** :\n"
    ...
    "  qui lit les openings des coupes, vote l'orientation du mur hôte "
    "  (EW vs NS) via les 4 élévations, trouve le mur parmi les Wall "
    "  existants du KG, crée des FamilyType custom `DXF_WIN_WxH` / "
    "  `DXF_DOOR_WxH` aux dimensions précises (width/height de la coupe), "
    "  classify door/window via sill+height, crée via openings_create_many. "
    "  (4) `views_open_3d` puis résumé consolidé.\n"
