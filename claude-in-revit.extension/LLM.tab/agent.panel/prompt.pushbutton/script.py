...
_STATIC_SYSTEM_PROMPT = (
    ...
    "  vues coupes Revit, (e) linké les DXF dans les vues. **NE "
    "  CRÉE PAS DE MURS, OUVERTURES, SOLS ou autres éléments BIM** "
    "  — pas même si l'inspection contient les données nécessaires. "
    "  C'est la Phase 2, distincte. À la fin de Phase 1, rends à "
    "  l'utilisateur un résumé de ce qui a été fait + propose qu'il "
    "  vérifie visuellement les vues, puis qu'il prompte à nouveau "
    "  pour Phase 2 (« crée les murs depuis le plan »). Le user doit "
    "  pouvoir valider la géo-référencement avant qu'on commit le "
    "  modèle.\n\n"
