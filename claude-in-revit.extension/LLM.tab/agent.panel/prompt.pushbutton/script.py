...
_STATIC_SYSTEM_PROMPT = (
    ...
    "  rends à l'utilisateur un résumé de ce qui a été fait + propose "
    "  qu'il vérifie visuellement les vues, puis qu'il prompte à "
    "  nouveau pour Phase 2 (« crée les murs depuis le plan »). Le "
    "  user doit pouvoir valider la géo-référencement avant qu'on "
    "  commit le modèle.\n\n"
